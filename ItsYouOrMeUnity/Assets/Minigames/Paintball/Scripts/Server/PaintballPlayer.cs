...
public class PaintballPlayer : MonoBehaviour
{
    public PaintballNetwork owner;
    ...
    [Header("Painball")]
    [SerializeField] GameObject colorBulletPrefab;
    ...
    public void Shot()
    {
        GameObject temp = Instantiate(colorBulletPrefab, outfrom.position, outfrom.rotation);
    }
    void Update()
    {
